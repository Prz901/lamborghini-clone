    ...
    <div className='container mx-auto py-20'>
      ...
      <section>
        ...
        <div className='flex w-full'>
          ...
          <div className='flex flex-col items-start justify-center max-h-full pl-16 '>
            <div>
              <h2 className='uppercase text-lg font-normal'>21 september 2020</h2>
            </div>
            <div className='flex flex-col h-full items-start justify-center md:mt-8 lg:mt-4 xl:mt-4'>
              <h3 className='px-3  bg-gray-200 hover:bg-black hover:text-white uppercase text-base'>Esports</h3>
              <h1 className='py-3 text-3xl font-bold w-full uppercase'>
        ...
        <div className='flex h-full py-20'>
          ...
          <div className='flex flex-col items-start max-h-full pl-16 '>
            ...
            <div className='flex flex-col h-full items-start justify-center md:mt-8 lg:mt-4 xl:mt-6'>
