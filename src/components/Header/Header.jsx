    ...
    <div className='flex items-center justify-between w-full background-lamborghini fixed z-10 px-10 h-24 top-0 '>
      <div className='flex items-center'>
        ...
        <div className='px-4 flex items-center'>
          ...
          <p className='text-gray-200 pr-4 pl-2 text-lg uppercase animate-border'>motorsport</p>
          <p className='text-gray-200 pr-4 pl-2 text-lg uppercase animate-border'>esports</p>
        </div>
      </div>
      <div>
        <div className='flex items-center'>
          <p className='text-gray-200 pr-6 pl-2 text-lg uppercase animate-border'>dealerships</p>
